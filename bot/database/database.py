...
class Database:
    ...
    async def prepare(self) -> None:
        ...
        try:
            ...
            raise Exception(
                "The current database tables haven't been updated. Perform the initial migration before starting work.")
    ...
    async def get_stats(self) -> dict[str, str | int | Any]:
    ...
    async def get_neuros_by_category(self,
                                     category: str,
                                     page: int,
                                     per_page: int) -> tuple[Any, int | Any]:
