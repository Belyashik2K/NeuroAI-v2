...
async def start_gen_image(call: types.CallbackQuery, callback_data: data.Neuro,
    ...
    if not call.message.photo and not call.message.video:
        await call.message.edit_text(text=text,
                                    reply_markup=inline.back(callback_data=data.Category(name=Category.IMAGE).pack()),
...
async def start_gen_audio(call: types.CallbackQuery, callback_data: data.Neuro,
    ...
    await call.message.edit_text(choices[callback_data.name], reply_markup=inline.back(callback_data=data.Category(name=Category.AUDIO).pack()))
