...
messages-info = 🙋 Добро пожаловать в мир нейросетей, { $name }!
    ...
    — <b>Абсолютно бесплатен</b> и работаю на основе <a href="https://api.futureforge.dev/docs">API FutureForge</a> и <a href="https://api.visioncraft.top/docs">API VisionCraft</a>
...
messages-whisper_voice = 🤖 <i>Выбранная нейросеть:</i> <code>{ $neuro }</code>
    ...
    <b>Отправьте аудиофайл, который нужно обработать</b> или нажмите кнопку <code>⬅️ Назад</code> для отмены запроса.

messages-whisper_mode = 🤖 <i>Выбранная нейросеть:</i> <code>{ $neuro }</code>

    <b>Выберите режим работы</b>

    ⚠️ <i>Перевод текста аудио происходит только на английский язык!</i>
...
messages-whisper_processing = 🤖 <i>Выбранная нейросеть:</i> <code>{ $neuro }</code>
    <i>❓ Выбранный режим:</i> <code>{ $mode }</code>

    😌 <i>Обработка запроса, пожалуйста, подождите...</i>

messages-whisper_result = 🤖 <i>Выбранная нейросеть:</i> <code>{ $neuro }</code>
    <i>❓ Выбранный режим:</i> <code>{ $mode }</code>

    <i>Ответ нейросети:</i> <code>{ $result }</code>
