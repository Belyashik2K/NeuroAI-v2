...
messages-about = 💬 <b>Про сервіс</b>
    ...
    🤖 Загальна кількість нейромереж: <code>{ $neuro_count }</code>
...
messages-whisper_voice = 🤖 <i>Обрана нейромережа:</i> <code>{ $neuro }</code>
    ...
    <b>Надішліть аудіофайл для обробки</b> або натисніть кнопку <code>⬅️ Назад</code>, щоб скасувати запит.

messages-whisper_mode = 🤖 <i>Обрана нейромережа:</i> <code>{ $neuro }</code>

    <b>Виберіть режим роботи</b>

    ⚠️ <i>Переклад тексту з аудіо підтримується лише англійською мовою!</i>
...
messages-whisper_processing = 🤖 <i>Обрана нейромережа:</i> <code>{ $neuro }</code>
    <i>❓ Обраний режим:</i> <code>{ $mode }</code>

    😌 <i>Обробка запиту, будь ласка, зачекайте...</i>

messages-whisper_result = 🤖 <i>Обрана нейромережа:</i> <code>{ $neuro }</code>
    <i>❓ Обраний режим:</i> <code>{ $mode }</code>

    <i>Відповідь нейромережі:</i> <code>{ $result }</code>
